...
@section('title', 'IION - Ratelimited')
...
@section('content')
    <section class="relative pt-16 pb-56 overflow-hidden">
        <div class="relative z-10 container mx-auto px-4">
            <img class="mx-auto mb-36 " src="/iion_logo.png" alt="">
            <img class="mb-11 mx-auto" src="/sad.svg" alt="">
            <div class="md:max-w-xl mx-auto mb-12">
                <h2 class="mb-5 font-heading font-bold text-6xl  text-gray-900 text-center">Oh no!
                    We've hit our ratelimit. Try again tomorrow.</h2>
            </div>
